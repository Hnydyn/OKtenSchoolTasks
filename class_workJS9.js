...
// for (const simpsony of simpsons) {
//     let divElement = document.createElement('div');
//     divElement.classList.add('member');
//     divElement.innerText = `${simpsony.name} ${simpsony.surname} ${simpsony.age}`
...
//     divName.innerText = simpsony.name;
//
//     let divSurname = document.createElement('div');
//     divSurname.innerText = simpsony.surname
//     let divAge = document.createElement('div');
//     divAge.innerText = simpsony.age;
//
//     let pInfo = document.createElement('p');
//     pInfo.innerText = simpsony.info;
//
//     let photo = document.createElement('img');
//     photo.src = simpsony.photo
//
//
...
//
//     let elementOfcourse = document.createElement('course');
//     let titleElement = document.createElement('h2');
//     titleElement.innerText = courses.title;
//
//     let monthDurationElement = document.createElement('div');
//     monthDurationElement.innerText = courses.monthDuration;
//     let hourDurationElement = document.createElement('div');
//     hourDurationElement.innerText = courses.hourDuration;
//
//     let modulesElement = document.createElement('ul');
//
//     for (const moduleItem of courses.modules) {
//         let module = document.createElement('li');
//         module.innerText = moduleItem;
//         modulesElement.appendChild(module);
//     }
//
//     elementOfcourse.appendChild(titleElement);
//     elementOfcourse.appendChild(monthDurationElement);
//     elementOfcourse.appendChild(hourDurationElement);
//     elementOfcourse.appendChild(modulesElement);
//     document.body.appendChild(elementOfcourse);
// };
//